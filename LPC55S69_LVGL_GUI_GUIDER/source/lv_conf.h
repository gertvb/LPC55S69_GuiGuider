...
#include <stdint.h>
#include "littlevgl_support.h" //for lcd_width and height
...
#define LV_HOR_RES_MAX          (LCD_WIDTH) //littlevgl_support.h
#define LV_VER_RES_MAX          (LCD_HEIGHT) //littlevgl_support.h
 ...
 * - 32: ARGB8888
 */
#define LV_COLOR_DEPTH  16 //(LCD_FB_BYTE_PER_PIXEL * 8) //littlevgl_support.h
