...
{
    BOARD_BootClock_FRO12_to_PLL150M();
}
...
/*******************************************************************************
 *************** Configuration BOARD_BootClock_FRO12_to_PLL150M ****************
 ******************************************************************************/
/* clang-format off */
/* TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
!!Configuration
name: BOARD_BootClock_FRO12_to_PLL150M
called_from_default_init: true
outputs:
- {id: CTIMER0_clock.outFreq, value: 1 MHz}
- {id: CTIMER3_clock.outFreq, value: 150 MHz}
- {id: HSLSPI_clock.outFreq, value: 50 MHz}
...
- {id: SYSCON.PLL0N_DIV.scale, value: '8', locked: true}
- {id: SYSCON.PLL0_PDEC.scale, value: '6', locked: true}
...
/*******************************************************************************
 * Variables for BOARD_BootClock_FRO12_to_PLL150M configuration
 ******************************************************************************/
/*******************************************************************************
 * Code for BOARD_BootClock_FRO12_to_PLL150M configuration
 ******************************************************************************/
void BOARD_BootClock_FRO12_to_PLL150M(void)
{
#ifndef SDK_SECONDARY_CORE
    /*!< Set up the clock sources */
    /*!< Configure FRO192M */
    ...
    const pll_setup_t pll0Setup = {
        ...
        .pllndec = SYSCON_PLL0NDEC_NDIV(8U),
        .pllpdec = SYSCON_PLL0PDEC_PDIV(3U),
    ...
    /*!< Set SystemCoreClock variable. */
    SystemCoreClock = BOARD_BOOTCLOCK_FRO12_TO_PLL150M_CORE_CLOCK;
#endif
}
